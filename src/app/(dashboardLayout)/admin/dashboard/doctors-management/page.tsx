import DoctorsManagementHeader from "@/components/Admin/DoctorsManagement/DoctorsManagementHeader";
import DoctorsTable from "@/components/Admin/DoctorsManagement/DoctorsTable";
import RefreshButton from "@/components/shared/RefreshButton";
import SearchFilter from "@/components/shared/SearchFilter";
// import SelectFilter from "@/components/shared/SelectFilter";
import TablePagination from "@/components/shared/TablePagination";
import TableSkeleton from "@/components/shared/TableSkeleton";
import { queryStringFormatter } from "@/components/ui/formatters";
...
const AdminDoctorsManagementPage = async ({
    ...
    const totalPages = Math.ceil(
        (doctorsResult?.meta?.total ?? 0) / (doctorsResult?.meta?.limit ?? 1)
    );
    return (
